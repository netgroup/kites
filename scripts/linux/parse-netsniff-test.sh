...
#TODO CAMBIARE CON VALORE PARAMETRICO
netsniff_input=$1
trafgen_input=$2
#netsniff_input=/vagrant/ext/kites/pod-shared/NETSNIFF-100byte-1000pps.txt
#trafgen_input=/vagrant/ext/kites/pod-shared/TRAFGEN-100byte-1000pps.txt
...
#echo $RX_TIME 
/vagrant/ext/kites/scripts/linux/create-csv-from-netsniff.sh $CNI $TEST_TYPE $PPS $VM_SRC $VM_DEST $POD_SRC $POD_DEST $IP_SRC $IP_DEST $INCOMING $PASSED $RX_TIME
done
