...
function append_csv_from_iperf() {
    ...
    echo "$CNI, $TEST_TYPE, $ID_EXP, $VM_SRC, $VM_DEST, $POD_SRC, $POD_DEST, $IP_SRC, $IP_DEST, $OUTGOING, $OUT_UNIT, $INCOMING, $INC_UNIT, $THROUGHPUT, $THR_UNIT, $RX_TIME, $TX_TIME, $TIMESTAMP, $CONFIG, $CONFIG_CODE" >>iperf-tests.csv
}
...
function append_csv_from_trafgen() {
    ...
    echo "$OUTGOING, $TX_TIME, $VM_SRC, $VM_DEST, $POD_SRC, $POD_DEST, $PPS, $ID_EXP, $BYTE" >>trafgen-tests.csv
}
