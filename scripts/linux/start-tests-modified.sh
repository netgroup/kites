...
vagrant ssh k8s-master-1.k8s-play.local -- -t '/vagrant/ext/kites/scripts/linux/start.sh weavenet 3 -nc'
# CALICO IPIP
echo -e "\n ###-----> VAGRANT PROVISION CLEAN UP <-----###\n"
vagrant provision --provision-with cleanup
echo -e "\n ###-----> WAIT 60 SECONDS <-----###\n"
...
vagrant ssh k8s-master-1.k8s-play.local -- -t '/vagrant/ext/kites/scripts/linux/start.sh calicoIPIP 3 -nc'
# CALICO VXLAN
echo -e "\n ###-----> VAGRANT PROVISION CLEAN UP <-----###\n"
vagrant provision --provision-with cleanup
echo -e "\n ###-----> WAIT 60 SECONDS <-----###\n"
...
vagrant ssh k8s-master-1.k8s-play.local -- -t '/vagrant/ext/kites/scripts/linux/start.sh calicoVXLAN 3 -nc'
# FLANNEL
echo -e "\n ###-----> VAGRANT PROVISION CLEAN UP <-----###\n"
vagrant provision --provision-with cleanup
echo -e "\n ###-----> WAIT 60 SECONDS <-----###\n"
...
vagrant ssh k8s-master-1.k8s-play.local -- -t '/vagrant/ext/kites/scripts/linux/start.sh flannel 3 -nc'
